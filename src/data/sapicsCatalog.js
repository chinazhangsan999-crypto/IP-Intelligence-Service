...
export const SAPICS_DATASETS = Object.freeze([
  ...
  { id: 'sapics-dbip-city', fileName: 'dbip-city.mmdb', kind: 'city', priority: 30, license: 'CC-BY-4.0' },
  { id: 'sapics-geolite2-city', fileName: 'geolite2-city.mmdb', kind: 'city', priority: 50, license: 'GeoLite2' },
